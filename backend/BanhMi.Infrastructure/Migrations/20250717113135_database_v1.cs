    ...
    public partial class database_v1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlockedUser", x => x.BlockId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserContact", x => x.ContactId);
                    table.ForeignKey(
                        name: "FK_UserContact_User_FriendId",
                        column: x => x.FriendId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupSetting", x => x.SettingId);
                    table.ForeignKey(
                        name: "FK_GroupSetting_Conversation_ConversationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MessageStatus_User_ReceiverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupSetting_ConversationId",
                table: "GroupSetting",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageStatus_ReceiverId",
                table: "MessageStatus",
                column: "ReceiverId");
